    ...
    return (
        <>
            ...
            <ul class = "quiz">
                ...
                <l1>
                    <h4>Which word is most appropriate to describe very small amounts in the field of Mathematics?</h4>
                    <ul class = "choices">
                        <li>
                            <label>
                ...
                <l1>
                    <h4>Which is the closest definition of ecstacy?</h4>
                    <ul class = "choices">
                        <li>
                            <label>
                                <input type = "radio" name = "question1" value = "A" />
                                <span> a state of overwhelming emotion </span>
                            </label>
                        </li>
                        <li>
                            <label>
                ...
                <l1>
                    <h4>Which word has a negative connotation?</h4>
                    <ul class = "choices">
                        <li>
                            <label>
